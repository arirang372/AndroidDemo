...
class AceUserSettingsPopulatorTest : AceBaseUserSettingsPopulatorTest() {
    ...
    private fun createTestObject(
        ...
        testObject = object : AceUserSettingsPopulator(resourceConverter) {
            ...
            override fun createPhoneValidationRuleFactory(target: AceUsersModel?):
                AceUserSettingsPhoneValidationRuleFactory {
                    return object :
                        AceUserSettingsPhoneValidationRuleFactory(
                            targetUsersModel,
                            resourceConverter
    ...
    fun testUserSettingsPopulator() {
        ...
        testUserSettingsPopulatorWith(
            isSpecialtyVehicle = true,
            shouldShowEditAddressButton = false
        )
        testUserSettingsPopulatorWith(
            isSpecialtyVehicle = false,
            shouldShowEditAddressButton = true
        )
        testUserSettingsPopulatorWith(
            isSpecialtyVehicle = false,
            shouldShowEditAddressButton = false
