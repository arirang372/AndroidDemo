...
@StringDef(value = {
        ...
        ViewTag.LOGIN_SETTINGS_PASSWORD_FRAGMENT,
        ViewTag.LOGIN_SETTINGS_SECURITY_QUESTIONS_FRAGMENT,
...
public @interface ViewTag {
    ...
    String LOGIN_SETTINGS_PASSWORD_FRAGMENT = "LOGIN_SETTINGS_PASSWORD_FRAGMENT";
    String LOGIN_SETTINGS_SECURITY_QUESTIONS_FRAGMENT = "LOGIN_SETTINGS_SECURITY_QUESTIONS_FRAGMENT";
