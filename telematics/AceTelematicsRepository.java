...
public class AceTelematicsRepository extends AceTierRepository<AceTelematicsModel> implements AceTelematicsUseCase {
    ...
    private void emitTelematicsDisabledNavigation() {
        emitNavigation(NavigateAction.TELEMATICS_OUTAGE);
    ...
    public void navigateToOutageSectionDestination(@NonNull AceTelematicsOutageSectionItem sectionItem) {
        switch (sectionItem.getSectionItemName()) {
            case FIND_GAS:
                startActivity(AceInventoryCalculatorOnboardingActivity.class);
                break;
            case GEICO_EXPLORE:
                startActivity(AceExploreOnboardingActivity.class);
                break;
            case GET_A_QUOTE:
                startActivity(AceGetAQuoteActivity.class);
                break;
            case ROADSIDE_ASSISTANCE:
                considerNavigatingToRoadsideHelp();
                break;
            case SAVED_ID_CARDS:
                startActivity(getSessionController().isUserAuthenticated() ? AcePreIdCardsActivity.class : AceSavedIdCardsActivity.class);
                break;
        }
    }
    ...
    public void onRetrieveDriverDataSuccess(@NonNull AceTelematicsDriver driver) {
        ...
        getModel().setShouldShowLogInForMoreOptions(!getSessionController().isUserAuthenticated());
