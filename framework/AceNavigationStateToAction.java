...
class AceNavigationStateToAction {
    ...
    private static NavDirections createActionLoginSettingsUserIdFragment() {
    ...
    private static Map<@NavigateAction String, NavDirections> createMapping() {
        ...
        mapping.put(NavigateAction.LOGIN_SETTINGS_USER_ID_FRAGMENT, createActionLoginSettingsUserIdFragment());
