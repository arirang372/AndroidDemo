...
public class AceDashboardStateEmitter extends AceBasicStateEmitter implements AceStateEmitterForDashboard {
    ...
    private final AceBasicOnDemandEmittedState keepMeLoggedInState = new AceBasicOnDemandEmittedState();
    ...
    public void addObserver(@NonNull AceEmittedStateObserver observer, @NonNull LifecycleOwner viewLifecycleOwner) {
        ...
        keepMeLoggedInState.observe(viewLifecycleOwner, observer::onEmittedStateChange);
        makePaymentState.observe(viewLifecycleOwner, observer::onEmittedStateChange);
    }

    @Override
    public void emitKeepMeLoggedInDialogVisibility(@Visibility int visibility) {
        keepMeLoggedInState.startObservingWithValue(new AceDialogVisibilityState(DialogTag.KEEP_ME_LOGGED_IN, visibility));
    }
    ...
    public void removeObservers(@NonNull LifecycleOwner viewLifecycleOwner) {
        ...
        keepMeLoggedInState.removeObservers(viewLifecycleOwner);
