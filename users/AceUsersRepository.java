...
public class AceUsersRepository extends AceTierRepository<AceUsersModel> {
    ...
    private AceListener createListenerForReturnToLoginPage() {
    ...
    private void navigateUserToLoginPage(@NonNull AceEvent<String, String> event) {
        ...
        new AceRapidSessionFinisher(getRegistry()).execute();
