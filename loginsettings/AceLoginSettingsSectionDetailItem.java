...
public class AceLoginSettingsSectionDetailItem {
    ...
    private final ObservableBoolean showPasswordStengthMeter = new ObservableBoolean(false);
    private final ObservableBoolean showPasswordAsStrong = new ObservableBoolean(false);
    private final ObservableBoolean showPasswordAsMedium = new ObservableBoolean(false);
    ...
    public void setShouldShowPasswordAsStrong(boolean showPasswordAsStrong) {
        this.showPasswordAsStrong.set(showPasswordAsStrong);
    }

    @NonNull
    public ObservableBoolean shouldShowPasswordAsStrong() {
        return showPasswordAsStrong;
    }

    public void setShouldShowPasswordAsMedium(boolean showPasswordAsMedium) {
        this.showPasswordAsMedium.set(showPasswordAsMedium);
    }

    @NonNull
    public ObservableBoolean shouldShowPasswordAsMedium() {
        return showPasswordAsMedium;
    }

    public void setShouldShowPasswordStringthMeter(boolean showPasswordStringthMeter) {
        this.showPasswordStengthMeter.set(showPasswordStringthMeter);
    }

    @NonNull
    public ObservableBoolean shouldShowPasswordStrengthMeter() {
        return showPasswordStengthMeter;
    }
