...
public abstract class AceBaseUserSettingsPopulator implements AcePopulator<AceRegistry, AceUsersModel> {
    ...
    protected AceUserSettingsSectionItem createUserSettingsSectionItemWith(String label, String text, boolean shouldShowSettingsText, boolean shouldShowSettingsEditText, boolean shouldEditUserSettingsButton, Drawable editUserSettingsButtonResource) {
        ...
        sectionItem.setEditUserSettingButtonResource(editUserSettingsButtonResource);
        return sectionItem;
    }
